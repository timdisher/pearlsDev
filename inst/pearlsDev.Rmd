...
so would likely induce collider bias which will require careful consideration to address. The best way forward will depend on which perspective you need and which assumptions you're willing to make.
